...
import com.test.common.LoginPage;
...
public class LoginCase<dataProvider> {
...
//        driver = new ChromeDriver(options);
    ...
    public Object[][] Login() throws IOException {
        return ReadExcel.getData("src\\test\\java\\com\\test\\datas","TestData.xlsx","TestData");
    }
...
//        driver.get("https://www.baidu.com");
        ...
        LoginPage.login(driver, name,password);
